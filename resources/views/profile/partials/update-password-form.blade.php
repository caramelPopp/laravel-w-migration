<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Garanta que sua senha seja longa e aleatória para manter-se seguro.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="bg-etec-red text-white hover:bg-red-700 transition">{{ __('Salvar') }}</x-primary-button>
